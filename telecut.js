...
var timestamps145 = [
3408, 3409, 3410, 3411, 3412, 3413, 3414, 3415, 3416, 3417, 3418, 3419, 3420, 3421, 3422, 3423, 3424, 3425, 3426, 3427, 3428, 3429, 3430, 3431 
]
var timestamps146 = [
...
//http://bucketeer-c970a6d1-f419-4561-b5d3-03be633a5c0c.s3.amazonaws.com/public/record2.mp4

var file = fs.createWriteStream("telecut/record2.mp4");
var request = http.get("http://videos-fms.jwpsrv.com/0_60fb7c6d_0x8d27a3be50bcf529bbea08fc244461094249674b/content/conversions/C3JiCH2S/videos/QEqrydyx-27672894.mp4", function(response) {
response.pipe(file);
...
ffmpeg('telecut/record2.mp4')
.screenshots({
timestamps: timestamps78,
filename: '%s.png',
size: '120x60',
folder: 'telecut'
})
.on('end', function() {
    console.log('Processing finished78');

ffmpeg('telecut/record2.mp4')
.screenshots({
timestamps: timestamps79,
filename: '%s.png',
size: '120x60',
folder: 'telecut'
})
.on('end', function() {
    console.log('Processing finished79');

ffmpeg('telecut/record2.mp4')
.screenshots({
timestamps: timestamps80,
filename: '%s.png',
size: '120x60',
folder: 'telecut'
})
.on('end', function() {
    console.log('Processing finished80');
...
ffmpeg('telecut/record2.mp4')
.screenshots({
timestamps: timestamps81,
filename: '%s.png',
size: '120x60',
folder: 'telecut'
})
.on('end', function() {
    console.log('Processing finished81');

ffmpeg('telecut/record2.mp4')
.screenshots({
timestamps: timestamps82,
filename: '%s.png',
size: '120x60',
folder: 'telecut'
})
.on('end', function() {
    console.log('Processing finished82');


ffmpeg('telecut/record2.mp4')
.screenshots({
timestamps: timestamps83,
filename: '%s.png',
size: '120x60',
folder: 'telecut'
})
.on('end', function() {
    console.log('Processing finished83');


ffmpeg('telecut/record2.mp4')
.screenshots({
timestamps: timestamps84,
filename: '%s.png',
size: '120x60',
folder: 'telecut'
})
.on('end', function() {
    console.log('Processing finished84');


ffmpeg('telecut/record2.mp4')
.screenshots({
timestamps: timestamps85,
filename: '%s.png',
size: '120x60',
folder: 'telecut'
})
.on('end', function() {
    console.log('Processing finished85');

ffmpeg('telecut/record2.mp4')
.screenshots({
timestamps: timestamps86,
filename: '%s.png',
size: '120x60',
folder: 'telecut'
})
.on('end', function() {
    console.log('Processing finished86');

ffmpeg('telecut/record2.mp4')
.screenshots({
timestamps: timestamps87,
filename: '%s.png',
size: '120x60',
folder: 'telecut'
})
.on('end', function() {
    console.log('Processing finished87');

ffmpeg('telecut/record2.mp4')
.screenshots({
timestamps: timestamps88,
filename: '%s.png',
size: '120x60',
folder: 'telecut'
})
.on('end', function() {
    console.log('Processing finished88');

ffmpeg('telecut/record2.mp4')
.screenshots({
timestamps: timestamps89,
filename: '%s.png',
size: '120x60',
folder: 'telecut'
})
.on('end', function() {
    console.log('Processing finished89');

ffmpeg('telecut/record2.mp4')
.screenshots({
timestamps: timestamps90,
filename: '%s.png',
size: '120x60',
folder: 'telecut'
})
.on('end', function() {
    console.log('Processing finished90');
...
ffmpeg('telecut/record2.mp4')
.screenshots({
timestamps: timestamps91,
filename: '%s.png',
size: '120x60',
folder: 'telecut'
})
.on('end', function() {
    console.log('Processing finished91');

ffmpeg('telecut/record2.mp4')
.screenshots({
timestamps: timestamps92,
filename: '%s.png',
size: '120x60',
folder: 'telecut'
})
.on('end', function() {
    console.log('Processing finished92');


ffmpeg('telecut/record2.mp4')
.screenshots({
timestamps: timestamps93,
filename: '%s.png',
size: '120x60',
folder: 'telecut'
})
.on('end', function() {
    console.log('Processing finished93');


ffmpeg('telecut/record2.mp4')
.screenshots({
timestamps: timestamps94,
filename: '%s.png',
size: '120x60',
folder: 'telecut'
})
.on('end', function() {
    console.log('Processing finished94');


ffmpeg('telecut/record2.mp4')
.screenshots({
timestamps: timestamps95,
filename: '%s.png',
size: '120x60',
folder: 'telecut'
})
.on('end', function() {
    console.log('Processing finished95');

ffmpeg('telecut/record2.mp4')
.screenshots({
timestamps: timestamps96,
filename: '%s.png',
size: '120x60',
folder: 'telecut'
})
.on('end', function() {
    console.log('Processing finished96');

ffmpeg('telecut/record2.mp4')
.screenshots({
timestamps: timestamps97,
filename: '%s.png',
size: '120x60',
folder: 'telecut'
})
.on('end', function() {
    console.log('Processing finished97');

ffmpeg('telecut/record2.mp4')
.screenshots({
timestamps: timestamps98,
filename: '%s.png',
size: '120x60',
folder: 'telecut'
})
.on('end', function() {
    console.log('Processing finished98');

ffmpeg('telecut/record2.mp4')
.screenshots({
timestamps: timestamps99,
filename: '%s.png',
size: '120x60',
folder: 'telecut'
})
.on('end', function() {
    console.log('Processing finished99');

ffmpeg('telecut/record2.mp4')
.screenshots({
timestamps: timestamps100,
filename: '%s.png',
size: '120x60',
folder: 'telecut'
})
.on('end', function() {
    console.log('Processing finished100');
...
ffmpeg('telecut/record2.mp4')
.screenshots({
timestamps: timestamps101,
filename: '%s.png',
size: '120x60',
folder: 'telecut'
})
.on('end', function() {
    console.log('Processing finished101');

ffmpeg('telecut/record2.mp4')
.screenshots({
timestamps: timestamps102,
filename: '%s.png',
size: '120x60',
folder: 'telecut'
})
.on('end', function() {
    console.log('Processing finished102');


ffmpeg('telecut/record2.mp4')
.screenshots({
timestamps: timestamps103,
filename: '%s.png',
size: '120x60',
folder: 'telecut'
})
.on('end', function() {
    console.log('Processing finished103');


ffmpeg('telecut/record2.mp4')
.screenshots({
timestamps: timestamps104,
filename: '%s.png',
size: '120x60',
folder: 'telecut'
})
.on('end', function() {
    console.log('Processing finished104');


ffmpeg('telecut/record2.mp4')
.screenshots({
timestamps: timestamps105,
filename: '%s.png',
size: '120x60',
folder: 'telecut'
})
.on('end', function() {
    console.log('Processing finished105');

ffmpeg('telecut/record2.mp4')
.screenshots({
timestamps: timestamps106,
filename: '%s.png',
size: '120x60',
folder: 'telecut'
})
.on('end', function() {
    console.log('Processing finished106');

ffmpeg('telecut/record2.mp4')
.screenshots({
timestamps: timestamps107,
filename: '%s.png',
size: '120x60',
folder: 'telecut'
})
.on('end', function() {
    console.log('Processing finished107');

ffmpeg('telecut/record2.mp4')
.screenshots({
timestamps: timestamps108,
filename: '%s.png',
size: '120x60',
folder: 'telecut'
})
.on('end', function() {
    console.log('Processing finished108');

ffmpeg('telecut/record2.mp4')
.screenshots({
timestamps: timestamps109,
filename: '%s.png',
size: '120x60',
folder: 'telecut'
})
.on('end', function() {
    console.log('Processing finished109');

ffmpeg('telecut/record2.mp4')
.screenshots({
timestamps: timestamps110,
filename: '%s.png',
size: '120x60',
folder: 'telecut'
})
.on('end', function() {
    console.log('Processing finished110');
...
ffmpeg('telecut/record2.mp4')
.screenshots({
timestamps: timestamps111,
filename: '%s.png',
size: '120x60',
folder: 'telecut'
})
.on('end', function() {
    console.log('Processing finished111');

ffmpeg('telecut/record2.mp4')
.screenshots({
timestamps: timestamps112,
filename: '%s.png',
size: '120x60',
folder: 'telecut'
})
.on('end', function() {
    console.log('Processing finished112');


ffmpeg('telecut/record2.mp4')
.screenshots({
timestamps: timestamps113,
filename: '%s.png',
size: '120x60',
folder: 'telecut'
})
.on('end', function() {
    console.log('Processing finished113');


ffmpeg('telecut/record2.mp4')
.screenshots({
timestamps: timestamps114,
filename: '%s.png',
size: '120x60',
folder: 'telecut'
})
.on('end', function() {
    console.log('Processing finished114');


ffmpeg('telecut/record2.mp4')
.screenshots({
timestamps: timestamps115,
filename: '%s.png',
size: '120x60',
folder: 'telecut'
})
.on('end', function() {
    console.log('Processing finished115');

ffmpeg('telecut/record2.mp4')
.screenshots({
timestamps: timestamps116,
filename: '%s.png',
size: '120x60',
folder: 'telecut'
})
.on('end', function() {
    console.log('Processing finished116');

ffmpeg('telecut/record2.mp4')
.screenshots({
timestamps: timestamps117,
filename: '%s.png',
size: '120x60',
folder: 'telecut'
})
.on('end', function() {
    console.log('Processing finished117');

ffmpeg('telecut/record2.mp4')
.screenshots({
timestamps: timestamps118,
filename: '%s.png',
size: '120x60',
folder: 'telecut'
})
.on('end', function() {
    console.log('Processing finished118');

ffmpeg('telecut/record2.mp4')
.screenshots({
timestamps: timestamps119,
filename: '%s.png',
size: '120x60',
folder: 'telecut'
})
.on('end', function() {
    console.log('Processing finished119');

ffmpeg('telecut/record2.mp4')
.screenshots({
timestamps: timestamps120,
filename: '%s.png',
size: '120x60',
folder: 'telecut'
})
.on('end', function() {
    console.log('Processing finished120');
...
ffmpeg('telecut/record2.mp4')
.screenshots({
timestamps: timestamps121,
filename: '%s.png',
size: '120x60',
folder: 'telecut'
})
.on('end', function() {
    console.log('Processing finished121');

ffmpeg('telecut/record2.mp4')
.screenshots({
timestamps: timestamps122,
filename: '%s.png',
size: '120x60',
folder: 'telecut'
})
.on('end', function() {
    console.log('Processing finished122');


ffmpeg('telecut/record2.mp4')
.screenshots({
timestamps: timestamps123,
filename: '%s.png',
size: '120x60',
folder: 'telecut'
})
.on('end', function() {
    console.log('Processing finished123');


ffmpeg('telecut/record2.mp4')
.screenshots({
timestamps: timestamps124,
filename: '%s.png',
size: '120x60',
folder: 'telecut'
})
.on('end', function() {
    console.log('Processing finished124');


ffmpeg('telecut/record2.mp4')
.screenshots({
timestamps: timestamps125,
filename: '%s.png',
size: '120x60',
folder: 'telecut'
})
.on('end', function() {
    console.log('Processing finished125');

ffmpeg('telecut/record2.mp4')
.screenshots({
timestamps: timestamps126,
filename: '%s.png',
size: '120x60',
folder: 'telecut'
})
.on('end', function() {
    console.log('Processing finished126');

ffmpeg('telecut/record2.mp4')
.screenshots({
timestamps: timestamps127,
filename: '%s.png',
size: '120x60',
folder: 'telecut'
})
.on('end', function() {
    console.log('Processing finished127');

ffmpeg('telecut/record2.mp4')
.screenshots({
timestamps: timestamps128,
filename: '%s.png',
size: '120x60',
folder: 'telecut'
})
.on('end', function() {
    console.log('Processing finished128');

ffmpeg('telecut/record2.mp4')
.screenshots({
timestamps: timestamps129,
filename: '%s.png',
size: '120x60',
folder: 'telecut'
})
.on('end', function() {
    console.log('Processing finished129');

ffmpeg('telecut/record2.mp4')
.screenshots({
timestamps: timestamps130,
filename: '%s.png',
size: '120x60',
folder: 'telecut'
})
.on('end', function() {
    console.log('Processing finished130');
...
ffmpeg('telecut/record2.mp4')
.screenshots({
timestamps: timestamps131,
filename: '%s.png',
size: '120x60',
folder: 'telecut'
})
.on('end', function() {
    console.log('Processing finished131');

ffmpeg('telecut/record2.mp4')
.screenshots({
timestamps: timestamps132,
filename: '%s.png',
size: '120x60',
folder: 'telecut'
})
.on('end', function() {
    console.log('Processing finished132');


ffmpeg('telecut/record2.mp4')
.screenshots({
timestamps: timestamps133,
filename: '%s.png',
size: '120x60',
folder: 'telecut'
})
.on('end', function() {
    console.log('Processing finished133');


ffmpeg('telecut/record2.mp4')
.screenshots({
timestamps: timestamps134,
filename: '%s.png',
size: '120x60',
folder: 'telecut'
})
.on('end', function() {
    console.log('Processing finished134');


ffmpeg('telecut/record2.mp4')
.screenshots({
timestamps: timestamps135,
filename: '%s.png',
size: '120x60',
folder: 'telecut'
})
.on('end', function() {
    console.log('Processing finished135');

ffmpeg('telecut/record2.mp4')
.screenshots({
timestamps: timestamps136,
filename: '%s.png',
size: '120x60',
folder: 'telecut'
})
.on('end', function() {
    console.log('Processing finished136');

ffmpeg('telecut/record2.mp4')
.screenshots({
timestamps: timestamps137,
filename: '%s.png',
size: '120x60',
folder: 'telecut'
})
.on('end', function() {
    console.log('Processing finished137');


ffmpeg('telecut/record2.mp4')
.screenshots({
timestamps: timestamps138,
filename: '%s.png',
size: '120x60',
folder: 'telecut'
})
.on('end', function() {
    console.log('Processing finished138');

ffmpeg('telecut/record2.mp4')
.screenshots({
timestamps: timestamps139,
filename: '%s.png',
size: '120x60',
folder: 'telecut'
})
.on('end', function() {
    console.log('Processing finished139');

ffmpeg('telecut/record2.mp4')
.screenshots({
timestamps: timestamps140,
filename: '%s.png',
size: '120x60',
folder: 'telecut'
})
.on('end', function() {
    console.log('Processing finished140');
...
ffmpeg('telecut/record2.mp4')
.screenshots({
timestamps: timestamps141,
filename: '%s.png',
size: '120x60',
folder: 'telecut'
})
.on('end', function() {
    console.log('Processing finished141');

ffmpeg('telecut/record2.mp4')
.screenshots({
timestamps: timestamps142,
filename: '%s.png',
size: '120x60',
folder: 'telecut'
})
.on('end', function() {
    console.log('Processing finished142');


ffmpeg('telecut/record2.mp4')
.screenshots({
timestamps: timestamps143,
filename: '%s.png',
size: '120x60',
folder: 'telecut'
})
.on('end', function() {
    console.log('Processing finished143');


ffmpeg('telecut/record2.mp4')
.screenshots({
timestamps: timestamps144,
filename: '%s.png',
size: '120x60',
folder: 'telecut'
})
.on('end', function() {
    console.log('Processing finished144');


ffmpeg('telecut/record2.mp4')
.screenshots({
timestamps: timestamps145,
filename: '%s.png',
size: '120x60',
folder: 'telecut'
})
.on('end', function() {
    console.log('Processing finished145');

ffmpeg('telecut/record2.mp4')
.screenshots({
timestamps: timestamps146,
filename: '%s.png',
size: '120x60',
folder: 'telecut'
})
.on('end', function() {
    console.log('Processing finished146');

ffmpeg('telecut/record2.mp4')
.screenshots({
timestamps: timestamps147,
filename: '%s.png',
size: '120x60',
folder: 'telecut'
})
.on('end', function() {
    console.log('Processing finished147');


ffmpeg('telecut/record2.mp4')
.screenshots({
timestamps: timestamps148,
filename: '%s.png',
size: '120x60',
folder: 'telecut'
})
.on('end', function() {
    console.log('Processing finished148');

ffmpeg('telecut/record2.mp4')
.screenshots({
timestamps: timestamps149,
filename: '%s.png',
size: '120x60',
folder: 'telecut'
})
.on('end', function() {
    console.log('Processing finished149');

ffmpeg('telecut/record2.mp4')
.screenshots({
timestamps: timestamps150,
filename: '%s.png',
size: '120x60',
folder: 'telecut'
})
.on('end', function() {
    console.log('Processing finished150');
...
ffmpeg('telecut/record2.mp4')
.screenshots({
timestamps: timestamps151,
filename: '%s.png',
size: '120x60',
folder: 'telecut'
})
.on('end', function() {
    console.log('Processing finished151');

ffmpeg('telecut/record2.mp4')
.screenshots({
timestamps: timestamps152,
filename: '%s.png',
size: '120x60',
folder: 'telecut'
})
.on('end', function() {
    console.log('Processing finished152');
